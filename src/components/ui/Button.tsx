...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap cursor-pointer rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-bg-secondary text-text-button shadow-xs",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "relative text-text-primary transition-color duration-300 z-10 border overflow-hidden hover:text-bg-primary shadow-xs before:absolute before:inset-0 before:z-0 before:bg-text-primary before:translate-x-[-100%] hover:before:translate-x-[0%] before:transition-all before:duration-300 [&>*]:relative [&>*]:z-10",
        secondary: "bg-bg-primary text-text-primary shadow-xs hover:opacity-90",
        ghost:
      ...
      size: {
        ...
        xl: "h-12 rounded-3xl px-6 text-lg",
        icon: "size-9",
      },
    },
    defaultVariants: {
